...
export const vocabularyPacks: VocabularyPack[] = [
  ...
  {
    id: "security-professional-vocabulary",
    name: "航空安全执勤专业词汇",
    description: "安全操作、紧急情况处理和执勤管理专业术语",
    icon: "Shield",
    items: [
      // 安全执勤术语
...
export const dialogues: Dialogue[] = [
  ...
  // 紧急情况对话
  {
    id: "emergency-situations-dialogues",
    title: "紧急情况对话",
    description: "处理各类紧急和特殊安全事件的对话场景",
    icon: "AlertTriangle",
    lines: [
      // In-flight Incident
