...
export const vocabularyPacks: VocabularyPack[] = [
  ...
  },
  {
    ...
    name: "Security Operations Terms",
    description: "Essential vocabulary for aviation security operations and procedures.",
    icon: "Shield",
    items: [
  ...
  },
  {
    ...
    name: "Onboard Equipment & Items",
    description: "Vocabulary for equipment and items found on aircraft.",
    icon: "Package",
    items: [
  ...
  {
    id: "passenger-behavior",
    name: "Passenger Behavior Management",
    description: "Terms related to managing passenger behavior and incidents.",
    icon: "Users",
    items: [
  ...
  },
  {
    ...
    description: "Critical vocabulary for handling emergency and security situations.",
    icon: "AlertTriangle",
    items: [
