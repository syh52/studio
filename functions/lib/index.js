...
exports.onUserDelete = exports.api = void 0;
...
app.post('/progress/save', async (req, res) => {
    try {
        ...
        batch.set(sessionRef, Object.assign(Object.assign({ uid }, sessionData), { timestamp: admin.firestore.FieldValue.serverTimestamp(), id: sessionRef.id }));
        // 更新用户统计
...
// 🔥 获取学习历史 - 分页查询避免大量数据传输
app.get('/progress/:uid', async (req, res) => {
    try {
        const { uid } = req.params;
